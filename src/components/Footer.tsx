    ...
    <footer className="bg-primary text-primary-foreground py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Alamat */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-accent">Alamat</h3>
          ...
          {/* Jadwal Misa */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-accent">Jadwal Misa</h3>
          ...
          {/* Tentang */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-accent">Gereja Katedral</h3>
            <p className="text-sm leading-relaxed">
